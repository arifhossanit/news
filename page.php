    ...
    <main class="container">
        ...
        <div class="row">
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_1.jpg"
                class="img-fluid"
                alt="world-news"
              />
          ...
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="row row-cols-1 row-cols-sm-2 g-4">
              <div class="col  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img
                    src="./images/business/Business_4.jpg"
                    class="img-fluid"
                    alt="world-news"
                  />
                  <span class="thumb-title">BUSINESS</span>
              ...
              <div class="col  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img
                    src="./images/business/Business_2.jpg"
                    class="img-fluid"
                    alt="world-news"
                  />
                  <span class="thumb-title">BUSINESS</span>
              ...
              <div class="col  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img
                    src="./images/business/Business_5.jpg"
                    class="img-fluid"
                    alt="world-news"
                  />
                  <span class="thumb-title">BUSINESS</span>
              ...
              <div class="col">
                <div class="position-relative image-hover">
                  <img
                    src="./images/business/Business_3.jpg"
                    class="img-fluid"
                    alt="world-news"
                  />
                  <span class="thumb-title">BUSINESS</span>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_6.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_10.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_14.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_16.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_8.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_12.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_18.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_20.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_7.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_11.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_15.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_17.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_9.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_13.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_19.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
          ...
          <div class="col mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="./images/business/Business_21.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">BUSINESS</span>
